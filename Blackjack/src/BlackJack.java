...
class BlackJackPlayer{
	...
	private int dealerChoice() {
			...
			draw_dealer=random.nextInt(12)+2; //card value is randomly generated
	...
	private int playerChoice() {
		...
		if(ch.equals("stay") && stay==0) {
			...
			draw_player=random.nextInt(12)+2; //hard code
	...
	public void playGame() {
		...
		//If the player sum is greater than 21, the dealer automatically wins.
		if(player_sum>=21) {
			money-=bet;
